    ...
    <div class="p-8">
        ...
        <div class="flex justify-between items-center mb-10">
            <div class="relative w-1/3">
                ...
                <input type="text" placeholder="Search metrics, invoices, or reports..." class="w-full bg-[#161922] border-none text-sm rounded-lg pl-10 pr-4 py-2 text-gray-300 focus:ring-1 focus:ring-cyan-500">
            </div>
        ...
        <div class="mb-10">
            ...
            <div class="flex justify-between items-end">
                <div>
                    ...
                    <p class="text-gray-400 mt-2 text-sm max-w-md">Real-time financial metrics, portfolio insights, and operational performance at a glance.</p>
                </div>
                <div class="flex gap-3">
                    ...
                    <button class="bg-gradient-to-r from-[#00d2ff] to-[#9d50bb] text-white px-5 py-2 rounded-lg text-sm font-bold flex items-center gap-2 hover:opacity-90 transition shadow-lg shadow-cyan-900/20">
        ...
        <div class="grid grid-cols-4 gap-4 mb-12">
            ...
            <div class="bg-[#161922] border border-gray-800 p-6 rounded-2xl hover:border-gray-700 transition-all duration-300 group">
                <div class="flex justify-between items-start">
                    <p class="text-[10px] font-bold text-gray-500 uppercase tracking-widest">{{ $stat['label'] }}</p>
                    <span class="text-[10px] font-bold {{ $stat['up'] ? 'text-green-400' : 'text-pink-400' }}">{{ $stat['change'] }}</span>
                </div>
        ...
        <div class="grid grid-cols-3 gap-6 mb-12">
            ...
            <div class="bg-gradient-to-br from-[#161922] to-[#0f111a] border border-gray-800 rounded-3xl p-8 flex flex-col justify-between shadow-2xl">
                ...
                <div class="pt-6 border-t border-gray-800">
                    <p class="text-[10px] text-gray-500 uppercase font-bold tracking-widest">Net Flow</p>
                    <p class="text-sm text-gray-300 mt-1">+Rp 758jt profit margin</p>
                </div>
            </div>
        </div>
                    ...
                    <table class="w-full text-left text-sm text-gray-400">
                        ...
                        <tbody class="divide-y divide-gray-800">
                            <tr class="hover:bg-[#1e222d] transition group cursor-pointer">
                                ...
                                <td class="px-6 py-5"><span class="bg-cyan-950 text-cyan-400 px-2 py-0.5 rounded text-[10px] font-bold border border-cyan-800 uppercase">Cleared</span></td>
                            ...
                            <tr class="hover:bg-[#1e222d] transition group cursor-pointer">
                                ...
                                <td class="px-6 py-5"><span class="bg-blue-900 text-blue-400 px-2 py-0.5 rounded text-[10px] font-bold uppercase">Verified</span></td>
                            ...
                            <tr class="hover:bg-[#1e222d] transition group cursor-pointer">
                                ...
                                <td class="px-6 py-5"><span class="bg-orange-950 text-orange-400 px-2 py-0.5 rounded text-[10px] font-bold border border-orange-800 uppercase">Pending</span></td>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider">{{ $budget['label'] }}</span>
                                <span class="text-sm font-bold text-white">{{ $budget['value'] }}</span>
                            </div>
                            <div class="h-2 bg-gray-800 rounded-full overflow-hidden">
                                <div class="h-full bg-gradient-to-r {{ $budget['gradient'] }} rounded-full transition-all duration-1000" style="width: {{ $budget['width'] }};"></div>
                            </div>
                        </div>
                        @endforeach
                    </div>

                    <a href="/reports" class="w-full mt-8 py-3 px-4 rounded-lg bg-[#1b1f29] text-white text-sm font-semibold flex items-center justify-center gap-2 border border-gray-700 hover:bg-gray-800 transition">
